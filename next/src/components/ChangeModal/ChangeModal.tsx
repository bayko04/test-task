...
import { setChanged, setChangeModal } from "@/store/reducers/ProductsSlice";
...
const ChangeModal: FC = () => {
  ...
  const { changingData, manufacturers, pageSw, changed } = useAppSelector(
  ...
  return (
    <div className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#fff] py-[16px] px-[10px] w-[340px] flex flex-col gap-[20px]">
      ...
      {changed && (
        <div className="">
          <h2 className="text-center">Товар успешно изменен</h2>
